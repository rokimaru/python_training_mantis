...
class SignupHelper:
    ...
    def new_user(self, username, email, password):
        ...
        wd.fing_element_by_name("username").send_keys(username)
        wd.fing_element_by_name("email").send_keys(email)
        ...
        wd.get(url)
        wd.fing_element_by_name("password").send_keys(password)
        wd.fing_element_by_name("password_confirm").send_keys(password)
